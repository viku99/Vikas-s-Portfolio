    ...
    case 'youtube':
      return (
        <div className="aspect-video">
          <iframe
            src={`https://www.youtube.com/embed/${media.src}?autoplay=1&mute=1&loop=1&playlist=${media.src}&controls=0&showinfo=0&rel=0`}
            frameBorder="0"
    ...
    <AnimatedPage type="cinematic">
      <>
        <motion.div initial={{opacity:0, y: -20}} animate={{opacity: 1, y: 0}} transition={{delay: 0.2}}>
            ...
            <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter">{project.title}</h1>
        </motion.div>
